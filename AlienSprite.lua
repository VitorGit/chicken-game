print("AlienSprite.lua loaded")

require "love.graphics"

local image_w = 1600 --This info can be accessed with a Löve2D call
local image_h = 400 --      after the image has been loaded. I'm creating these for readability.
local sprite_w = 400
local sprite_h = 400
...
return {
    ...
    sprite_sheet = "sprites/Alien.png", -- The path to the spritesheet
	sprite_name = "alien", -- The name of the sprite
